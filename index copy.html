            ...
            <section class="hero text-center">
                ...
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title mt-0 is-revealing">CAST-4</h1>
                        <p class="hero-paragraph is-revealing">
							Cast 4 is the main project under the club services avenue of the Rotaract club of University of Moratuwa. This is a series of projects conducting through out the year under the aim of bringing all the members in the club together.
                        ...
                        <div class="features-wrap">
                            <div class="feature">
                                <div class="feature-inner">
										<center><img src="water.png" width="90" height="90"></center>
                                    ...
                                    <h3 class="feature-title mt-24">Water Nation</h3>
                                    <p class="text-sm">Their souls flow with water, keeping the balance within themselves. They are peaceful in nature, but deadly when provoked</p>
                                </div>
                            </div>
                            <div class="feature">
                                <div class="feature-inner">
										<center><img src="fire.png" width="90" height="90"></center>
                                 <div class="feature-icon">
									  <!-- 	<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
										    <defs>
                                    ...
                                    <h3 class="feature-title mt-24">Fire Nation</h3>
                                    <p class="text-sm">Their souls are dancing with flames blazing within.. They seek to extend their empire until all four corners of earth are beneath the shadows of their flares..</p>
                                </div>
                            </div>
                        </div>
                        <div class="features-wrap">
                            <div class="feature">
                                <div class="feature-inner">
										<center><img src="air.png" width="90" height="90"></center>
                                    ...
                                    <h3 class="feature-title mt-24">Air Nation</h3>
                                    <p class="text-sm">Their souls embrace the wind with their hands as peaceful as can be. Bending air is only to protect oneself and never harm another, the nation thrives with peace and prosperity..</p>
                                </div>
                            </div>
                            <div class="feature">
                                <div class="feature-inner">
										<center><img src="earth.png" width="90" height="90"></center>
...
<!--
                                    ...
                                    <h3 class="feature-title mt-24">Team Earth</h3>
                                    <p class="text-sm">Their souls are as deep as the roots of the aged trees. 
										Bending earth and standing firmly on the ground they defend their nation with great ferocity..
									</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="brand footer-brand">
                        <a href="#">
								<img src=http://rotaractmora.org/blog/wp-content/uploads/2016/09/Untitled-1-1.png width="140" height="140">
						
								<title>Rotaract Mora</title>
								<!--
								<defs>
                    ...
                    <ul class="footer-links list-reset">
                        ...
                        <li>
                            <a href="http://rotaractmora.org">About us</a>
                        </li>
                    ...
                    <div class="footer-copyright">&copy; 2019 Rotaract Mora, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
